...
public class Browser extends PageObject{
    ...
    public static void js_sendkeys(PageObject page, WebElement we, String value){
        JavascriptExecutor js = (JavascriptExecutor) page.getDriver();
        js.executeScript("arguments[0].value='"+value+"';",we );
    }//para reemplazar el sendkeys que siempre usamos, solo que es para los que tienen pantalla pequeña
